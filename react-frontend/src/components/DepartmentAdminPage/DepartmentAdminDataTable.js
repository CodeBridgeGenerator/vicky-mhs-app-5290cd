...
const DepartmentAdminDataTable = ({
    ...
    const dropdownTemplate1 = (rowData, { rowIndex }) => <p>{rowData.employeeId?.fullname}</p>;
    ...
    return (
        <>
            ...
            <Dialog header="Upload DepartmentAdmin Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search DepartmentAdmin" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
