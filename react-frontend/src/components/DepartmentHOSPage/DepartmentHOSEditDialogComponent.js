...
const DepartmentHOSCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit DepartmentHOS" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: '40vw' }} className="min-w-max" footer={renderFooter()} resizable={false}>
