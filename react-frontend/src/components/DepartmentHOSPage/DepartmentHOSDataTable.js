...
const DepartmentHOSDataTable = ({
    ...
    const dropdownTemplate0 = (rowData, { rowIndex }) => <p>{rowData.sectionId?.name}</p>;
    ...
    return (
        <>
            <DataTable
                ...
                loading={loading}
            >
                <Column field="sectionId" header="SectionId" body={dropdownTemplate0} filter={selectedFilterFields.includes('sectionId')} hidden={selectedHideFields?.includes('sectionId')} style={{ minWidth: '8rem' }} />
            ...
            <Dialog header="Upload DepartmentHOS Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search DepartmentHOS" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
...
export default DepartmentHOSDataTable;
