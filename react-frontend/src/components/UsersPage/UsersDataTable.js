...
const UsersDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,  showUpload, setShowUpload,
    showFilter, setShowFilter,
    showColumns,
    setShowColumns,
    onClickSaveFilteredfields,
    selectedFilterFields, setSelectedFilterFields,
    selectedHideFields, setSelectedHideFields,onClickSaveHiddenfields
}) => {
    ...
    const paginatorRight = DownloadCSV({ data : items, fileName : "users"});
    ...
    return (
      ...
      <Dialog header="Search Users" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      SearchService
    </Dialog>
    <Dialog
        header="Filter Users"
