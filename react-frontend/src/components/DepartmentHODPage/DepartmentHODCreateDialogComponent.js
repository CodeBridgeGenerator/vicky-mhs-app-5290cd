...
const DepartmentHODCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        try {
            ...
            props.alert({
                type: 'error',
                title: 'Create',
                message: 'Failed to create in DepartmentHOD'
            });
        }
        setLoading(false);
    };
    ...
    return (
        <Dialog header="Create DepartmentHOD" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: '40vw' }} className="min-w-max" footer={renderFooter()} resizable={false}>
