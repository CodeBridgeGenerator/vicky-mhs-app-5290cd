...
const CompaniesPage = (props) => {
    ...
    useEffect(() => {
        let service = _.find(config.services, { serviceName: 'companies' });
        if (!service) {
            service = _.find(standard.services, { serviceName: 'companies' });
        }
    ...
    return (
        <div className="mt-5">
            ...
            <CompaniesCreateDialogComponent entity={newRecord} show={showCreateDialog} onHide={() => setShowCreateDialog(false)} onCreateResult={onCreateResult} />
