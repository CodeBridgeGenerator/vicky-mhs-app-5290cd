...
const PermissionServicesCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        try {
            ...
            props.alert({
                type: 'success',
                title: 'Create info',
                message: 'Info Permission Services updated successfully'
            });
            ...
            props.alert({
                type: 'error',
                title: 'Create',
                message: 'Failed to create in Permission Services'
            });
        }
        setLoading(false);
    };
    ...
    return (
        <Dialog header="Create Permission Services" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: '40vw' }} className="min-w-max" footer={renderFooter()} resizable={false}>
