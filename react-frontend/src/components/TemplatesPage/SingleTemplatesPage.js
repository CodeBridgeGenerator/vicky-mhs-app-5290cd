                ...
                <div className="card w-full">
                    <div className="grid ">
                        ...
                        <div className="col-12 md:col-6 lg:col-3">
                            ...
                            <p className="m-0 ml-3" dangerouslySetInnerHTML={{ __html: _entity?.body }}></p>
                        </div>
                        <div className="col-12 md:col-6 lg:col-3">
                            <label className="text-sm text-primary">Variables</label>
                            <p className="m-0 ml-3" dangerouslySetInnerHTML={{ __html: _entity?.variables?.map((v) => `<span className="col">${v}</span>`) }}></p>
                        </div>
                        <div className="col-12 md:col-6 lg:col-3">
