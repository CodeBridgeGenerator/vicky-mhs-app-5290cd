...
const RolesDataTable = ({
    ...
    return (
        <>
            ...
            <Dialog header="Upload Roles Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search Roles" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
