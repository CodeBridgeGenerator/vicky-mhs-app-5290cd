...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Price</label><p className="m-0 ml-3" ><InputNumber id="price" value={Number(_entity?.price)} mode="currency" currency="MYR" locale="en-US"   disabled={true} /></p></div>
