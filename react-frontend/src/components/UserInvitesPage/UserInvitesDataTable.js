...
const UserInvitesDataTable = ({
    ...
    const p_numberTemplate3 = (rowData, { rowIndex }) => <p>{rowData.sendMailCounter}</p>;
    ...
    return (
        <>
            <DataTable
                ...
                loading={loading}
            >
                <Column field="emailToInvite" header="Invitation Email" body={pTemplate0} filter={selectedFilterFields.includes('emailToInvite')} hidden={selectedHideFields?.includes('emailToInvite')} sortable style={{ minWidth: '8rem' }} />
                <Column field="status" header="Status" body={pTemplate1} filter={selectedFilterFields.includes('status')} hidden={selectedHideFields?.includes('status')} style={{ minWidth: '8rem' }} />
                ...
                <Column field="sendMailCounter" header="SendMailCounter" body={p_numberTemplate3} filter={selectedFilterFields.includes('sendMailCounter')} hidden={selectedHideFields?.includes('sendMailCounter')} sortable style={{ minWidth: '8rem' }} />
