...
const DepartmentsDataTable = ({
    ...
    return (
        <>
            ...
            <Dialog header="Upload Departments Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search Departments" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
