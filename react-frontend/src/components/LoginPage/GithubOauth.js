...
const GithubOauth = (props) => {
    ...
    return (
        <>
            <Button onClick={handleGithubOauth} style={{ background: '#fff', padding: '10px 30px' }} className="flex gap-20 items-center">
                <i className="pi pi-github" style={{ color: 'black', fontSize: '20px' }}></i>
                <div
                    style={{
                        color: '#000',
                        fontSize: '1.2rem',
