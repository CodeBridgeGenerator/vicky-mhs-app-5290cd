...
const SingleErrorsPage = (props) => {
    ...
    }, [props, urlParams.singleErrorsId]);
            ...
            <div className="col-12 flex flex-column align-items-center">
                <div className="col-10">
                    <div className="flex align-items-center justify-content-start">
                        ...
                        <h3 className="m-0">Errors</h3>
                    </div>
                    <p>errors/{urlParams.singleErrorsId}</p>
...
export default connect(mapState, mapDispatch)(SingleErrorsPage);
