    ...
    return (
        <>
            ...
            >
                ...
                <Column field="error" header="Error" body={pTemplate1} filter={selectedFilterFields.includes('error')} hidden={selectedHideFields?.includes('error')} style={{ minWidth: '8rem' }} />
                <Column field="message" header="Message" body={pTemplate2} filter={selectedFilterFields.includes('message')} hidden={selectedHideFields?.includes('message')} sortable style={{ minWidth: '8rem' }} />
                <Column field="stack" header="Stack" body={pTemplate3} filter={selectedFilterFields.includes('stack')} hidden={selectedHideFields?.includes('stack')} sortable style={{ minWidth: '8rem' }} />
                <Column field="details" header="Details" body={pTemplate4} filter={selectedFilterFields.includes('details')} hidden={selectedHideFields?.includes('details')} style={{ minWidth: '8rem' }} />
            ...
            <Dialog header="Upload Errors Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search Errors" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
