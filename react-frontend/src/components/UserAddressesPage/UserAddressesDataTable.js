...
const UserAddressesDataTable = ({
    ...
    return (
        <>
            ...
            <Dialog header="Upload UserAddresses Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search UserAddresses" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
...
export default UserAddressesDataTable;
