...
const NotificationsCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create Notifications" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: '40vw' }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="notifications-create-dialog-component">
                ...
                <div className="col-12 md:col-6 field mt-5">
                    <span className="align-items-center">
                        ...
                        <Calendar id="sent" value={_entity?.sent ? new Date(_entity?.sent) : new Date()} onChange={(e) => setValByKey('sent', e.value)} showTime hourFormat="12" />
                    </span>
                    <small className="p-error">
...
export default connect(mapState, mapDispatch)(NotificationsCreateDialogComponent);
