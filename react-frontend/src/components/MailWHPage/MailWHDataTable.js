...
const MailWHDataTable = ({
    ...
    const pTemplate1 = (rowData, { rowIndex }) => <p>{rowData.data}</p>;
    ...
    return (
        <>
            ...
            >
                ...
                <Column field="data" header="Data" body={pTemplate1} filter={selectedFilterFields.includes('data')} hidden={selectedHideFields?.includes('data')} style={{ minWidth: '8rem' }} />
            ...
            <Dialog header="Upload MailWH Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search MailWH" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
...
export default MailWHDataTable;
