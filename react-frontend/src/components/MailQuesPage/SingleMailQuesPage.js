...
const SingleMailQuesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .then((res) => {
                set_entity(res || {});
                const templateId = Array.isArray(res.templateId) ? res.templateId.map((elem) => ({ _id: elem._id, name: elem.name })) : res.templateId ? [{ _id: res.templateId._id, name: res.templateId.name }] : [];
                ...
                <div className="card w-full">
                    <div className="grid ">
                        ...
                        <div className="col-12 md:col-6 lg:col-3">
                            ...
                            <p className="m-0 ml-3">
                                <i id="status" className={`pi ${_entity?.status ? 'pi-check' : 'pi-times'}`}></i>
                            </p>
                        </div>
                        <div className="col-12 md:col-6 lg:col-3">
