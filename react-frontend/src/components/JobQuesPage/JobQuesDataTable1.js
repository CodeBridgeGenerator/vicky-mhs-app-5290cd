    ...
    return (
        <>
            ...
            >
                ...
                <Column field="data" header="Data" body={pTemplate2} filter={selectedFilterFields.includes('data')} hidden={selectedHideFields?.includes('data')} sortable style={{ minWidth: '8rem' }} />
                <Column field="service" header="Service" body={pTemplate3} filter={selectedFilterFields.includes('service')} hidden={selectedHideFields?.includes('service')} sortable style={{ minWidth: '8rem' }} />
                <Column field="start" header="Start" body={calendar_timeonlyTemplate4} filter={selectedFilterFields.includes('start')} hidden={selectedHideFields?.includes('start')} sortable style={{ minWidth: '8rem' }} />
                <Column field="end" header="End" body={calendar_timeonlyTemplate5} filter={selectedFilterFields.includes('end')} hidden={selectedHideFields?.includes('end')} sortable style={{ minWidth: '8rem' }} />
