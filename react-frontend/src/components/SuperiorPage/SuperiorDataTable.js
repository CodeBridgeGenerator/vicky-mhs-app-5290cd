...
const SuperiorDataTable = ({
    ...
    const p_numberTemplate0 = (rowData, { rowIndex }) => <p>{rowData.superior}</p>;
    const pTemplate1 = (rowData, { rowIndex }) => <p>{rowData.subordinate}</p>;
    ...
    return (
        <>
            <DataTable
                ...
                loading={loading}
            >
                <Column field="superior" header="Superior" body={p_numberTemplate0} filter={selectedFilterFields.includes('superior')} hidden={selectedHideFields?.includes('superior')} sortable style={{ minWidth: '8rem' }} />
                <Column field="subordinate" header="Subordinate" body={pTemplate1} filter={selectedFilterFields.includes('subordinate')} hidden={selectedHideFields?.includes('subordinate')} sortable style={{ minWidth: '8rem' }} />
            ...
            <Dialog header="Upload Superior Data" visible={showUpload} onHide={() => setShowUpload(false)}>
                <UploadService />
            </Dialog>

            <Dialog header="Search Superior" visible={searchDialog} onHide={() => setSearchDialog(false)}>
                Search
            </Dialog>
...
export default SuperiorDataTable;
