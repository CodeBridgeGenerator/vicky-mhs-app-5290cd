                ...
                <div className="card w-full">
                    <div className="grid ">
                        <div className="col-12 md:col-6 lg:col-3">
                            <label className="text-sm text-primary">Superior</label>
                            <p className="m-0 ml-3">{Number(_entity?.superior)}</p>
                        </div>
                        <div className="col-12 md:col-6 lg:col-3">
                            <label className="text-sm text-primary">Subordinate</label>
                            <p className="m-0 ml-3">{_entity?.subordinate}</p>
                        </div>
